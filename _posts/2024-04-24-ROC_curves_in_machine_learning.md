...
- ### **Confusion Matrix:** Confusion matrices are visualization tools used especially for supervised learning, in unsupervised learning they are generally called matching matrices. In image accuracy evaluation, it is mainly used to compare the classification results with the actual measured values, and the accuracy of the classification results can be displayed inside a confusion matrix.[2]           
    ...
    [![Confusion matrix](/master/images/Confusion_matrix.jpg "Confusion matrix")](https://blog.csdn.net/seagal890/article/details/105059498)          
...
[![ROC Curve](/master/images/Roc_Curve.jpg) "ROC Curve"](https://vitalflux.com/roc-curve-auc-python-false-positive-true-positive-rate/)  
...
## **Reference**
[1]:“What Is ROC Curve in Machine Learning?,” Coursera, Mar. 19, 2024. https://www.coursera.org/articles/what-is-roc-curve              
[2]:Mason , “[Machine Learning Notes] Confusion Matrix，” Mar. 03, 2020. https://blog.csdn.net/seagal890/article/details/105059498          
[3]:A. Kumar, “ROC Curve & AUC Explained with Python Examples,” Data Analytics, Sep. 02, 2020. https://vitalflux.com/roc-curve-auc-python-false-positive-true-positive-rate/
‌ 
